...
/**	
	Hook that retrieves Google Fonts API key from TO
**/
add_filter( 'ot_google_fonts_api_key', 'boc_set_google_fonts_api_key');

if( ! function_exists( 'boc_set_google_fonts_api_key' ) ) { 
	function boc_set_google_fonts_api_key( $string ) {
		
		// Get from TO, default is the default theme's one
		$google_fonts_api_key = ot_get_option('google_fonts_api_key','AIzaSyB8G-4UtQr9fhDYTiNrDP40Y5GYQQKrNWI');
