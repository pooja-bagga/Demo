...
$custom_settings = array(
  ...
  'settings'        => array(
	...
	array(
	  ...
	  'type'        => 'text',
	  'desc'        => 'Enter your Google Fonts API key here and click "SAVE CHANGES". <a href="https://developers.google.com/fonts/docs/developer_api#APIKey" target="_blank">Get one here</a>.',
	  'section'     => 'typography',
	  ),       	  
	...
	array(
		...
		'id'          => 'google_fonts',
		'desc'        => 'Select the Google Fonts you want to use. Once you click "SAVE CHANGES" they will be added as options into the Font-Family dropdowns below. If your list is empty make sure you enter your Google API key above and click "SAVE CHANGES"! You don\' have to add "Montserrat", "Droid Serif" and "Lato" google fonts as they are part of the theme by default.',
		'type'        => 'google-fonts',
		'section'     => 'typography',
	  ), 	  
